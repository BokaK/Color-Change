...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            scene = new Scene(1);
            count = 0;
            scene.AddSquare_Ball(105, 80, count);
        ...
        public void DrawStars(Graphics g, int y)
        {
            ...
            {
                g.DrawImageUnscaled(star, 142, 45);

            }
            else if (y < 275)
            {
                g.DrawImageUnscaled(star, 142, 165);
                g.DrawImageUnscaled(star, 142, 45);

            }
            else if (y < 400)
            {
                g.DrawImageUnscaled(star, 142, 280);
                g.DrawImageUnscaled(star, 142, 165);
                g.DrawImageUnscaled(star, 142, 45);
            ...
            {
                g.DrawImageUnscaled(star, 142, 403);
                g.DrawImageUnscaled(star, 142, 280);
                g.DrawImageUnscaled(star, 142, 165);
                g.DrawImageUnscaled(star, 142, 45);
            ...
            {
                g.DrawImageUnscaled(star, 142, 523);
                g.DrawImageUnscaled(star, 142, 403);
                g.DrawImageUnscaled(star, 142, 280);
                g.DrawImageUnscaled(star, 142, 165);
                g.DrawImageUnscaled(star, 142, 45);
