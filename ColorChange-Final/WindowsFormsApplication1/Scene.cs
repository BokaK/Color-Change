...
namespace WindowsFormsApplication1
{
     public class Scene
    {
        ...
        internal void AddThreeSquares(float x, float y, int count)
        {
            ThreeSquares t = new ThreeSquares(x, y, count);
            Shapes.Add(t);
        }
        ...
        internal void AddDiamond(float x, float y, int count)
        {
            DiamondBallsCircle d = new DiamondBallsCircle(x, y, count);
            Shapes.Add(d);
        }
    }
}
