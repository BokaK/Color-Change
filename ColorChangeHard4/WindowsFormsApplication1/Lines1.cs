    ...
    public class Lines1 : Shape
    {
        ...
        public override void Draw(Graphics g)
        {
            ...
            if (count % 4 == 1)
            {
                    ...
                    //X += 65;
                    g.DrawLine(p3, X+65, Y, X + 65, Y);
                   // X += 65;
                    g.DrawLine(p4, X+130, Y, X + 65, Y);
                   // X += 65;
                    g.DrawLine(p1, X+195, Y, X + 65, Y);
                  //  X += 65;
                    g.DrawLine(p2, X+260, Y, X + 65, Y);
            ...
            if (count % 4 == 2)
            {
                    ...
                    //X += 65;
                    g.DrawLine(p4, X+65, Y, X + 65, Y);
                   // X += 65;
                    g.DrawLine(p1, X+130, Y, X + 65, Y);
                   // X += 65;
                    g.DrawLine(p2, X+195, Y, X + 65, Y);
                   // X += 65;
                    g.DrawLine(p3, X+260, Y, X + 65, Y);
            ...
            if (count % 4 == 3)
            {
                   ...
                   // X += 65;
                    g.DrawLine(p1, X+65, Y, X + 65, Y);
                  //  X += 65;
                    g.DrawLine(p2, X+130, Y, X + 65, Y);
                   // X += 65;
                    g.DrawLine(p3, X+195, Y, X + 65, Y);
                   // X += 65;
                    g.DrawLine(p4, X+260, Y, X + 65, Y);
