    ...
    class Iks : Shape
    {
        ...
        public override void Draw(Graphics g)
        {
            ...
            if (count % 16 == 0)
            {
                ...
                g.DrawLine(p1, X - 20, Y + 20, X + 100, Y + 20);
                g.DrawLine(p2, X + 100, Y + 20, X + 100, Y - 100);
                g.DrawLine(p3, X + 100, Y - 100, X - 20, Y - 100);
                g.DrawLine(p4, X - 20, Y - 100, X - 20, Y + 20);
            }
            if (count % 16 == 1)
            {
            ...
            if (count % 16 == 4)
            {
                ...
                g.DrawLine(p2, X - 20, Y + 20, X + 100, Y + 20);
                g.DrawLine(p3, X + 100, Y + 20, X + 100, Y - 100);
                g.DrawLine(p4, X + 100, Y - 100, X - 20, Y - 100);
                g.DrawLine(p1, X - 20, Y - 100, X - 20, Y + 20);
            }
            if (count % 16 == 5)
            {
            ...
            if (count % 16 == 8)
            {
                ...
                g.DrawLine(p3, X - 20, Y + 20, X + 100, Y + 20);
                g.DrawLine(p4, X + 100, Y + 20, X + 100, Y - 100);
                g.DrawLine(p1, X + 100, Y - 100, X - 20, Y - 100);
                g.DrawLine(p2, X - 20, Y - 100, X - 20, Y + 20);
            }
            if (count % 16 == 9)
            {
            ...
            if (count % 16 == 12)
            {
                ...
                g.DrawLine(p4, X - 20, Y + 20, X + 100, Y + 20);
                g.DrawLine(p1, X + 100, Y + 20, X + 100, Y - 100);
                g.DrawLine(p2, X + 100, Y - 100, X - 20, Y - 100);
                g.DrawLine(p3, X - 20, Y - 100, X - 20, Y + 20);
            }
            if (count % 16 == 13)
            {
